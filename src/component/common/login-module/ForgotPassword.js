                            ...
                            <Form /*onSubmit={this.state.otpSent ? this.verifyOtp : this.sendOtp}*/>
                                <FormGroup className="mobile-detail">
                                    <FormLabel style={{width: "100%"}}>
                                        Enter Mobile No.
                                        {this.state.otpSent ?
                                            <button className="change-number transparent-btn"
                                                    onClick={this.changeNumber}>Change
                                                Number</button> : null}
                                    </FormLabel>
                                    <InputGroup>
                                        <i>
        ...
        return (
            <FormGroup className="verify-otp">
                <FormLabel style={{width: "100%"}}>
                    ...
                    <button className="resend-otp transparent-btn" onClick={this.sendOtp}>Resend OTP</button> : null}
                </FormLabel>
                <FormLabel className="otp-input">
                        <FormControl onFocus={this.selectText} type="number" maxLength="1" data-index="0" min="0"
                                     max="9"
                                     onChange={this.setOtpData} value={otp[0]} id="otp-input" name="otp-input"
                                     autoFocus/>
                        <FormControl onFocus={this.selectText} type="number" maxLength="1" data-index="1" min="0"
                                     max="9"
                                     onChange={this.setOtpData} value={otp[1]} id="otp-input" name="otp-input"/>
                        <FormControl onFocus={this.selectText} type="number" maxLength="1" data-index="2" min="0"
                                     max="9"
                                     onChange={this.setOtpData} value={otp[2]} id="otp-input" name="otp-input"/>
                    <FormControl onFocus={this.selectText} type="number" maxLength="1" data-index="3" min="0"
                                     max="9"
