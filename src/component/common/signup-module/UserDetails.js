...
class UserDetails extends React.Component {
    ...
    render() {
        let {fName, lName, email, dob, gender, college, course, city, state} = this.state;
        return (
            <Form>
                <div className="row">
                    <div className="col-md-6 col-xs-12">
                        <FormGroup>
                            ...
                            <Row>
                                <Col>
                                    <Form.Control type="text" name="firstName" placeholder="First name" value={fName}
                                                  onChange={this.updateName}
                                                  required/>
                                </Col>
                                <Col>
                                    <Form.Control type="text" name="lastName" placeholder="Last Name" value={lName}
                                                  onChange={this.updateName}
                                                  required/>
                                </Col>
                            </Row>
                        ...
                        <FormGroup>
                            ...
                            <div className="custom-control custom-radio custom-control-inline">
                                ...
                                <FormLabel className="custom-control-label" htmlFor="customRadio">Male </FormLabel>
                            </div>
                            <div className="custom-control custom-radio custom-control-inline">
                                ...
                                <FormLabel className="custom-control-label" htmlFor="customRadio1">Female </FormLabel>
                            </div>
                            <div className="custom-control custom-radio custom-control-inline">
                                <FormControl type="radio" className="custom-control-input" id="customRadio2"
                                             ...
                                             value="Other"
                                             onChange={this.updateGender}/>
                                <FormLabel className="custom-control-label" htmlFor="customRadio2">Other </FormLabel>
                            </div>
                        </FormGroup>
                        <FormGroup>
