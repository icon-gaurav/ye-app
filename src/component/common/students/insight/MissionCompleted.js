            ...
            <div className="Block0">
                <div className="Block1">
                    ...
                    <div className="Block3">
                        ...
                        <img className="imgclass1 col-sm-2 col-lg-2 col-md-6 col-8 " src={Background} width="100px" height="90px" />
                        ...
                        <div className="">
                            <h6 className=" opacity-115 pt-2 col-lg-10 col-md-10 col-10">Swach Bharat Abhiyan Internship</h6>
                            <p className="opacity-75 pt-2 col-lg-10 col-md-10 col-12">Task Description:To go in your Neighbourhood and take pictures of cleaning your society </p>
                        </div>
                        <p className="float-right pr-4  col-7"><strong>End Date</strong><span className="opacity-50">:12/12/19</span></p>
                        <p className="col-lg-5 col-md-5 col-3"><strong>Start Date</strong><span className="opacity-50">:2/5/19</span></p>

                        <div className={this.state.expand ? "d-block" : "d-none"}>
                            <h3 className="text-align-center border-top border-bottom border-top pt-1 pb-2">Uploaded Document</h3>
                                            ...
                                            <div className="col-12">
                                                <div className="row">
                                                    <div className="col-2">
                                                        ...
                                                        <div className="position-relative text-align-center pt-1 pb-1"
                                                        >
                                                    ...
                                                    <div className="remark col-10">
                                                        ...
                                                        <br></br>
                                                        <div
                                                            className="remark-summary d-inline-block m-auto col-5"><strong> Remark: </strong>{upload.Remark}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div className="Block3">
                        ...
                        <button className="btn  dropdown-toggle  float-right"  eonClick={this.changeView} >

                        </button>

                        <div className="">
                            <h6 className="opacity-115 pt-2 col-lg-10 col-md-10 col-10">Swach Bharat Abhiyan Internship</h6>
                            <p className="opacity-75 pt-2 col-lg-10 col-md-10 col-12">To go in your Neighbourhood and take pictures of cleaning your society </p>
                        </div>
                        <p className="float-right pr-4  col-7"><strong>End Date</strong><span className="opacity-50">:12/12/19</span></p>
                        <p className="col-lg-5 col-md-5 col-3"><strong>Start Date</strong><span className="opacity-50">:2/5/19</span></p>
